...
class _RestaurantLoginState extends State<RestaurantLogin> {
  static final _restaurantLoginKey = GlobalKey<FormState>();

  // These Hold the values we will send to Firebase
  static TextEditingController restaurantLoginEmailController =
      TextEditingController();
  static TextEditingController restaurantLoginPasswordController =
      TextEditingController();
  ...
  Future<void> logInUser() async {
    try {
      UserCredential userCredential =
        ...
        email: restaurantLoginEmailController.text,
        password: restaurantLoginPasswordController.text,
      );
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        /*    CollectionReference restaurants = FirebaseFirestore
                            .instance
                            .collection('restaurants');
                        DocumentSnapshot studentSnapshot = await restaurants
                            .doc("5JwmNvOcknUtOqtYEYnMBaFTaev1")
                            .get();

                        print(studentSnapshot);

                        restaurants
                            .doc("7TKgZgGncCbBx3uWD6oZlmmFBq03")
                            .set(studentSnapshot.data()); */
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            controller: restaurantLoginEmailController,
                          ...
                          TextFormField(
                            controller: restaurantLoginPasswordController,
                            decoration: const InputDecoration(
                                border: OutlineInputBorder(),
                                labelText: "Password"),
                            obscureText: true,
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        if (_restaurantLoginKey.currentState!.validate()) {
                          logInUser();
